...
REM log-folder-sizes.bat C: subfolders 3                    -> log all folders and subfolders up to depth 3
REM log-folder-sizes.bat C: subfolders -1                   -> log all folders and subfolders with unlimited depth
...
if not "%1"=="" (
    set "SearchPath=%1"
    REM Remove trailing backslash from SearchPath if present
