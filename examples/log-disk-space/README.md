...
This folder contains scripts to log the sizes of folders within a specified directory. These tools are useful for monitoring disk usage, auditing project storage, and identifying large folders.
