...
param(
    [string]$source = "C:\SOURCE-ACTIVE",
    [string]$backupDest = "C:\Users\hansz\OneDrive\Dokumente\SOURCE-ACTIVE",
    [string]$logFile = "C:\Users\hansz\OneDrive\Dokumente\SOURCE-ACTIVE\BACKUP.csv",
